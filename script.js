...
function updateTextCoordinates() {
    ...
    const textPoints1 = getTextCoordinates('Sayuu <3 solo quiero decirte que hare de todo Con tal', fontSize, centerY - totalHeight / 1);
    const textPoints2 = getTextCoordinates('De verte feliz preciosota hermosa dueña de mi corazon.🌻', fontSize, centerY + totalHeight / 1);
